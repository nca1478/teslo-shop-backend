...
export interface SeedProduct {
  ...
  tags: string[];
  gender: Gender;
  categoryType: 'shirts' | 'pants' | 'hoodies' | 'hats';
  images: string[];
}
...
export const products: SeedProduct[] = [
  ...
  {
    description:
      'The Thermal Cuffed Beanie has a premium, thermal-lined design for warmth and comfort in cold weather conditions. The beanie features a subtle silicone-printed Tesla wordmark and our signature T logo and is made from 100% acrylic knit.',
