...
export class ProductsController {
    ...
    async createProduct(@Body() createProductDto: CreateProductDto, @GetUser() user: User) {
    ...
    @ApiResponse({ status: 403, description: 'Forbidden - Admin role required' })
    async deleteProductImage(@Param('id') productId: string, @Body() body: { imageUrl: string }) {
